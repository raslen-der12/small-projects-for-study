...
<header class='heed'>
      ...
      <div class="profile" style="display:none;">
         ...
         ?>
         <div class="gohome"> <h1 class='hh1'>that's it</h1></div>
         <div>
   ...
   <section class="ever">
    <?php
    require( 'config.php');
    $req="select  nomP from pays where idPays='$idPay'";
    $res=mysqli_query($cnx,$req) or die("Erreur req ");
    $t=mysqli_fetch_array($res);
    $req1="select unaccepts from pays  where idPays='$idPay' ";
    ...
    <div class="griyed">
    <p><?php echo "$t[0]"?> does not accept all types of travelers for exemple this ccountry do not accept peopel arrived for <?php echo "$t2[0]";?> please respect the laws and guidelines when applying for a visa</p>
    <img src="<?php echo"$im";?>" width=500 >
    </div>
    </article>
