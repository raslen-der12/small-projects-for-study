...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 23 fév. 2024 à 04:47
...
INSERT INTO `booking` (`idApp`, `idLoc`, `dateBooking`, `checkIn`, `duree`, `total`) VALUES
(2, 1, '2024-02-01', '2024-03-12', 2, '200'),
(2, 1, '2024-02-23', '2024-02-24', 5, '500'),
(2, 2, '2024-02-23', '2024-04-14', 5, '1200');
...
--
ALTER TABLE `booking`
  ADD PRIMARY KEY (`idApp`,`idLoc`,`dateBooking`);
